...
disc = keras.models.load_model(r'/Main project/models/transfer_classifier_100%.h5',
                               custom_objects={'MinibatchDiscrimination': MinibatchDiscrimination,
                                                   'GlorotUniform': init})
classifier = keras.models.load_model(r'/Main project/models/regular_classifer_100%.h5',
                                     custom_objects={'MinibatchDiscrimination': MinibatchDiscrimination,
                                                     'GlorotUniform': init})

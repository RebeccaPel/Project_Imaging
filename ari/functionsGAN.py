...
from keras.layers import Input, LayerNormalization, MultiHeadAttention, BatchNormalization, Dropout
from keras.layers.convolutional import Conv2D, Conv2DTranspose

# import adaln
from resnet import ResBlock, ResBlockDown
...
def get_discriminator_histopathology():
   ...
   """
    ...
    layer_out = Dense(1, activation='sigmoid')(layer_in)
...
def get_generator_histopathology(latent_dim=200):
    ...
    layer_in = Conv2DTranspose(512, kernel_size=(2, 2), strides=(2, 2), padding='same')(
        layer_in)  # CHECK IF UPSCALE WORKS
    ...
    layer_in = Conv2DTranspose(256, kernel_size=(2, 2), strides=(2, 2), padding='same')(
        layer_in)  # CHECK IF UPSCALE WORKS
    ...
    layer_in = Conv2DTranspose(128, kernel_size=(2, 2), strides=(2, 2), padding='same')(
        layer_in)  # CHECK IF UPSCALE WORKS

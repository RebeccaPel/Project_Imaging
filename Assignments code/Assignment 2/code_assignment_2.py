# -*- coding: utf-8 -*-
"""
Created on Thu Feb 10 08:17:22 2022
...
# "curly digits": 2, 5 = 2
# "other": 3, 4 = 3
mapping = {0:1, 1:0, 2:2, 3:3, 4:3, 5:2, 6:1, 7:0, 8:1, 9:1}
y_train = [mapping[i] for i in y_train_ex3]
y_val = [mapping[i] for i in y_val_ex3]
y_test = [mapping[i] for i in y_test_ex3]

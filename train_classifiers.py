...
discriminator = keras.models.load_model('logs/old models/gan_discriminator_epoch_lower_lr145.h5',
...
keras.models.save_model(transfer, r"transfer_classifier_{}%.h5".format(subsample_factor))
keras.models.save_model(standard, r"regular_classifer_{}%.h5".format(subsample_factor))
keras.models.save_model(pre_trained, r"densenet_classifer_{}%.h5".format(subsample_factor))
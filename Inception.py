...
from working_simple_gan import get_generator_histopathology, get_pcam_generators
import numpy as np
import keras
...
image_size = (32, 32)
train_gen, val_gen = get_pcam_generators(r'C:\Users\justi\PycharmProjects\pythonProject\train+val',                                       image_size, batch_size, batch_size)
